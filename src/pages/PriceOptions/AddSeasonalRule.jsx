  ...
  return (
    <div>
      ...
      <div className="flex gap-[31.125rem]">
        ...
        <label htmlFor="role" className="block">
            ...
            <div className="mr-3 text-[14px]">
              ...
              <input type= "date" className="w-[200px] h-[30px] p-2 border-1 border-slate-200 rounded uppercase"
                 />
     ...
     <div className='flex gap-[40.5rem]'>
          ...
          <select className="w-[300px] h-[40px]">
      ...
      <div className="flex justify-between">
        ...
        <div className="mb-2 flex items-center">
            <label htmlFor="input1" className="mb-0">Weekday</label>
        </div>
        <input
            type="text"
      ...
      <div className="flex flex-col mr-8 text-xs text-slate-500">
        <div className="mb-2 flex items-center">
            <label htmlFor="input1" className="mb-0">Weekend</label>
        </div>
        <input
            type="text"
            className="w-[200px] py-[0.36rem] mb-4 border border-gray-300 rounded text-left text-[16px]"
      ...
      <div className="flex flex-col mr-8 text-xs text-slate-500">
        <div className="mb-2 flex items-center">
            <label htmlFor="input1" className="mb-0">Weekly</label>
      ...
      <div className="flex flex-col mr-8 text-xs text-slate-500">
        <div className="mb-2 flex items-center">
            <label htmlFor="input1" className="">Monthly</label>
            <CiCircleAlert className="w-[20px] h-[20px] text-sky-500 mr-2" />
          </div>
        <input
            type="text"
      ...
      <div className="flex flex-col mr-8 text-xs text-slate-500">
        <div className="mb-2 flex items-center">
            <label htmlFor="input5" className="">Extra Adult</label>
            <CiCircleAlert className="w-[20px] h-[20px] text-sky-500 mr-2" />
          </div>
          <input
            type="text"
