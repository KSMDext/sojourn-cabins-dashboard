...
const UpdateExtraCharge = () => {
  return (
    <div>
    <p className="mx-[30px] mt-[20px] text-4xl font-semibold">UpdateExtraCharge</p>
...
{/* Row 2 */}
    <div>
      <div className="flex">
        <div className="flex flex-col mt-[20px]">
          <div className="flex items-center">
            <span>UpdateExtraCharge Per</span>
            <CiCircleAlert className="w-[20px] h-[20px] text-sky-500"/>
          </div>
          <input 
...
{/* Row 3 */}
    ...
    <div className="mt-[230px] ml-[1050px] mb-[20px]">
      <button className="bg-white rounded w-[98px] h-[32px] hover:bg-current  " type="button"><Link to="/UpdateExtracharge" className="hover:text-white">Cancel</Link></button> 
...
export default UpdateExtraCharge