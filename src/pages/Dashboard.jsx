...
const Dashboard = () => {
  ...
  return (
    <div className="p-4">
      <div className="text-3xl mt-6 ml-5 Bold">Dashboard</div>

      <div className="grid grid-cols-1 gap-4 md:grid-cols-3 mt-6">
        <Link to="#">
          <div className="w-84 h-32  bg-white ml-5 rounded-lg p-4">
        ...
        <Link to="#">
        <div className="w-84 h-32  bg-white mr-5 rounded-lg p-4">
